  ...
  methods: {
    checkVersion: function () {
      $.ajax({
        ...
        type: "GET",
          ...
          this.showError("<p>Local server not started.</p>");
        }).always(() => {
          this.loading = false;
        })
    },
    ...
    generatePreloadCode() {
      ...
      if (platform == "ios") {
        ...
        console.error("Unsupported Device", this.platform,this.deviceId)
        codeLines = [
          `print("Unsupported Platform: ${this.platform} deviceId: ${this.deviceId}")`
        ]
      }
